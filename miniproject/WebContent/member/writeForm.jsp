	...
	<table border="1" cellspacing="3" cellpadding="1">
		...
		<tr>
			...
			<td><input type="text" name="id" id="id" placeholder="아이디 입력"
				style="width: 500px;"> <input type="button" value="중복체크"
				onclick="checkID()"> <input type="hidden" name="check"
				value=""></td>
		</tr>
		...
		<tr>
			...
			<td><input type="password" name="pwd" id="pwd" style="width: 500px;"></td>
		</tr>
		...
		<tr>
			...
			<td><input type="text" name="email1" id="email1"
				style="width: 225px;"> @ <input type="text" name="email2"
				id="email2" placeholder="직접입력" list="list" style="width: 225px;">
				<datalist id=list>
		...
		<tr>
			<td colspan="2" align="Center"><input type="button" value="회원가입"
				onclick="checkWrite()"> <input type="reset" value="다시작성"></td>
		</tr>
