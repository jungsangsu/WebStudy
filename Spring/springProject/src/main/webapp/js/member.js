...
function checkID(){
	...
	if(sID =="")
	{
		...
		window.open("http://localhost:8080/miniproject/member/checkID.do?id="+sID,"","width=450 height=100 left=300 top=100 locations=yes");
	}
}
...
function checkPost()
{
	window.open("/miniproject/member/checkPost.do?","","width=700 height=500");
}
