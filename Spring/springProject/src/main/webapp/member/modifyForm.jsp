...
<form name="modifyForm" method="post"
	action="http://localhost:8080/miniproject/member/modify.do">
	<table border="1" cellspacing="10" cellpadding="10">
		...
		<tr>
			...
			<td><input type="text" name="name" id="name"
				value="${requestScope.memberDTO.name }" style="width: 500px;"></td>
		</tr>
		...
		<tr>
			...
			<td><input type="text" name="id" id="id"
				value="${requestScope.memberDTO.id }" style="width: 500px;">
		...
		<tr>
			...
			<td><input type="text" name="pwd" id="pwd" style="width: 500px;"></td>
		</tr>
		...
		<tr>
			...
			<td><input type="text" name="email1" id="email1"
				value="${requestScope.memberDTO.email1 }" style="width: 225px;">
				@ <input type="text" name="email2" id="email22" placeholder="직접입력"
				list="list" style="width: 225px;"> <datalist id=list>
		...
		<tr>
			...
			<td><select name="tel1" id="tel1">
				...
				value="${requestScope.memberDTO.tel2 }" style="width: 200px;">
				- <input type="text" name="tel3" id="tel3"
				value="${requestScope.memberDTO.tel3 }" style="width: 200px;"></td>
		</tr>

		<tr>
			<td rowspan="3" align="Center">주소</td>
			<td><input type="text" name="zipcode" id="daum_zipcode"
				value="${requestScope.memberDTO.zipcode }" readonly> <input
				type="button" name="zipbutton" value="우편번호검색" onclick="checkPost()"></td>
		</tr>
		<tr>
			<td><input type="text" name="addr1" id="daum_addr1"
				value="${requestScope.memberDTO.addr1 }" style="width: 500px;"
				readonly></td>
		</tr>
		<tr>
			<td><input type="text" name="addr2" id="daum_addr2"
				value="${requestScope.memberDTO.addr2 }" style="width: 500px;"></td>
		</tr>
